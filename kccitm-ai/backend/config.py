...
class Settings(BaseSettings):
    ...
    MILVUS_AKTU_COLLECTION: str = "aktu_knowledge"
    ...
    # ── OpenAI fallback (disabled by default — zero code paths change when off) ──
    OPENAI_API_KEY: str = ""          # Empty = disabled. Set in .env to enable.
    OPENAI_MODEL: str = "gpt-4o-mini" # Cheapest option (~$0.15/1M input tokens)
    OPENAI_ENABLED: bool = False      # Master switch. Must be True AND key set.
